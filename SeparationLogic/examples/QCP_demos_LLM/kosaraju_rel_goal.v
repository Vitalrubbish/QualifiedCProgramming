...
forall (sid_pre: Z) (vis2_pre: Z) (fadj_row_pre: Z) (fadj_col_pre: Z) (n_pre: Z) (u_pre: Z) (root_pre: Z) (X_low_level_spec: (unit -> (KSt -> Prop))) (root_v_low_level_spec: Z) (fadj_row_l_low_level_spec: (@list Z)) (fadj_col_l_low_level_spec: (@list Z)) (g_low_level_spec: AdjGraph) (vis2_m: (@list Z)) (sid_m: (@list Z)) (i: Z) (lo: Z) (hi: Z) (v: Z) (PreH1 : (csr_wf2 g_low_level_spec fadj_col_l_low_level_spec fadj_row_l_low_level_spec vis2_m sid_m )) (PreH2 : ((adj_verts (g_low_level_spec)) = n_pre)) (PreH3 : (safeExec (pre_dfs2 (g_low_level_spec) (fadj_col_l_low_level_spec) (fadj_row_l_low_level_spec) (vis2_m) (sid_m) (root_v_low_level_spec)) (dfs_scc_from (g_low_level_spec) (fadj_col_l_low_level_spec) (fadj_row_l_low_level_spec) (root_pre) (u_pre) (i)) X_low_level_spec )) (PreH4 : (lo = (csr_lo (u_pre) (fadj_row_l_low_level_spec)))) (PreH5 : (hi = (csr_hi (u_pre) (fadj_row_l_low_level_spec)))) (PreH6 : (0 <= lo)) (PreH7 : (lo <= i)) (PreH8 : (i < hi)) (PreH9 : (hi <= (m_of (fadj_row_l_low_level_spec)))) (PreH10 : (0 <= u_pre)) (PreH11 : (u_pre < n_pre)) (PreH12 : (0 <= root_pre)) (PreH13 : (root_pre < n_pre)) (PreH14 : (n_pre <= INT_MAX)) (PreH15 : (0 <= v)) (PreH16 : (v < n_pre)) (PreH17 : (v = (Znth (i) (fadj_col_l_low_level_spec) (0)))) ,
...
forall (sid_pre: Z) (vis2_pre: Z) (fadj_row_pre: Z) (fadj_col_pre: Z) (n_pre: Z) (u_pre: Z) (root_pre: Z) (X_low_level_spec: (unit -> (KSt -> Prop))) (root_v_low_level_spec: Z) (fadj_row_l_low_level_spec: (@list Z)) (fadj_col_l_low_level_spec: (@list Z)) (g_low_level_spec: AdjGraph) (vis2_m: (@list Z)) (sid_m: (@list Z)) (i: Z) (lo: Z) (hi: Z) (v: Z) (vis2_l_: (@list Z)) (sid_l_: (@list Z)) (PreH1 : (csr_wf2 g_low_level_spec fadj_col_l_low_level_spec fadj_row_l_low_level_spec vis2_l_ sid_l_ )) (PreH2 : ((adj_verts (g_low_level_spec)) = n_pre)) (PreH3 : (safeExec (pre_dfs2 (g_low_level_spec) (fadj_col_l_low_level_spec) (fadj_row_l_low_level_spec) (vis2_l_) (sid_l_) (root_v_low_level_spec)) (applyf ((dfs_scc_fromK (g_low_level_spec) (fadj_col_l_low_level_spec) (fadj_row_l_low_level_spec) (root_pre) (u_pre) ((i + 1 )))) (tt)) X_low_level_spec )) (PreH4 : ((Znth v vis2_m 0) = 0)) (PreH5 : (csr_wf2 g_low_level_spec fadj_col_l_low_level_spec fadj_row_l_low_level_spec vis2_m sid_m )) (PreH6 : ((adj_verts (g_low_level_spec)) = n_pre)) (PreH7 : (lo = (csr_lo (u_pre) (fadj_row_l_low_level_spec)))) (PreH8 : (hi = (csr_hi (u_pre) (fadj_row_l_low_level_spec)))) (PreH9 : (0 <= lo)) (PreH10 : (lo <= i)) (PreH11 : (i < hi)) (PreH12 : (hi <= (m_of (fadj_row_l_low_level_spec)))) (PreH13 : (0 <= u_pre)) (PreH14 : (u_pre < n_pre)) (PreH15 : (0 <= root_pre)) (PreH16 : (root_pre < n_pre)) (PreH17 : (n_pre <= INT_MAX)) (PreH18 : (0 <= v)) (PreH19 : (v < n_pre)) (PreH20 : (v = (Znth (i) (fadj_col_l_low_level_spec) (0)))) ,
  (IntArray.full fadj_col_pre (m_of (fadj_row_l_low_level_spec)) fadj_col_l_low_level_spec )
  **  (IntArray.full fadj_row_pre (n_pre + 1 ) fadj_row_l_low_level_spec )

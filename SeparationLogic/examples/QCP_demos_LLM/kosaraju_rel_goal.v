...
(
forall (sid_pre: Z) (vis2_pre: Z) (fadj_row_pre: Z) (fadj_col_pre: Z) (n_pre: Z) (u_pre: Z) (root_pre: Z) (X_low_level_spec: (unit -> (KSt -> Prop))) (root_v_low_level_spec: Z) (fadj_row_l_low_level_spec: (@list Z)) (fadj_col_l_low_level_spec: (@list Z)) (g_low_level_spec: AdjGraph) (hi: Z) (lo: Z) (i: Z) (vis2_m: (@list Z)) (sid_m: (@list Z)) (PreH1 : (i < hi)) (PreH2 : (csr_wf2 g_low_level_spec fadj_col_l_low_level_spec fadj_row_l_low_level_spec vis2_m sid_m )) (PreH3 : (csr2_faithful g_low_level_spec fadj_col_l_low_level_spec fadj_row_l_low_level_spec )) (PreH4 : ((adj_verts (g_low_level_spec)) = n_pre)) (PreH5 : (safeExec (pre_dfs2 (g_low_level_spec) (fadj_col_l_low_level_spec) (fadj_row_l_low_level_spec) (vis2_m) (sid_m) (root_v_low_level_spec)) (dfs_scc_from (g_low_level_spec) (fadj_col_l_low_level_spec) (fadj_row_l_low_level_spec) (root_pre) (u_pre) (i)) X_low_level_spec )) (PreH6 : (lo = (csr_lo (u_pre) (fadj_row_l_low_level_spec)))) (PreH7 : (hi = (csr_hi (u_pre) (fadj_row_l_low_level_spec)))) (PreH8 : (0 <= lo)) (PreH9 : (lo <= i)) (PreH10 : (i <= hi)) (PreH11 : (hi <= (m_of (fadj_row_l_low_level_spec)))) (PreH12 : (0 <= u_pre)) (PreH13 : (u_pre < n_pre)) (PreH14 : (0 <= root_pre)) (PreH15 : (root_pre < n_pre)) (PreH16 : (n_pre <= INT_MAX)) (PreH17 : ((Znth (u_pre) (vis2_m) (0)) <> 0)) (PreH18 : ((Znth (u_pre) (sid_m) (0)) = (Znth (root_pre) (sid_m) (0)))) (PreH19 : forall (j_2: Z) , (((lo <= j_2) /\ (j_2 < i)) -> ((Znth ((Znth (j_2) (fadj_col_l_low_level_spec) (0))) (vis2_m) (0)) <> 0))) ,
  (IntArray.full fadj_col_pre (m_of (fadj_row_l_low_level_spec)) fadj_col_l_low_level_spec )
  **  (IntArray.full fadj_row_pre (n_pre + 1 ) fadj_row_l_low_level_spec )
  **  (IntArray.full vis2_pre n_pre vis2_m )
  **  (IntArray.full sid_pre n_pre sid_m )
...
(
forall (sid_pre: Z) (vis2_pre: Z) (fadj_row_pre: Z) (fadj_col_pre: Z) (n_pre: Z) (u_pre: Z) (root_pre: Z) (X_low_level_spec: (unit -> (KSt -> Prop))) (root_v_low_level_spec: Z) (fadj_row_l_low_level_spec: (@list Z)) (fadj_col_l_low_level_spec: (@list Z)) (g_low_level_spec: AdjGraph) (vis2_m_2: (@list Z)) (sid_m_2: (@list Z)) (i: Z) (lo: Z) (hi: Z) (v: Z) (vis2_l_: (@list Z)) (sid_l_: (@list Z)) (PreH1 : (csr_wf2 g_low_level_spec fadj_col_l_low_level_spec fadj_row_l_low_level_spec vis2_l_ sid_l_ )) (PreH2 : ((adj_verts (g_low_level_spec)) = n_pre)) (PreH3 : (safeExec (pre_dfs2 (g_low_level_spec) (fadj_col_l_low_level_spec) (fadj_row_l_low_level_spec) (vis2_l_) (sid_l_) (root_v_low_level_spec)) (applyf ((dfs_scc_fromK (g_low_level_spec) (fadj_col_l_low_level_spec) (fadj_row_l_low_level_spec) (root_pre) (u_pre) ((i + 1 )))) (tt)) X_low_level_spec )) (PreH4 : ((Znth (v) (vis2_l_) (0)) <> 0)) (PreH5 : ((Znth (v) (sid_l_) (0)) = (Znth (root_pre) (sid_l_) (0)))) (PreH6 : forall (w: Z) , (((0 <= w) /\ (w < n_pre)) -> (((Znth (w) (vis2_m_2) (0)) <> 0) -> ((Znth (w) (vis2_l_) (0)) <> 0)))) (PreH7 : forall (w_2: Z) , (((0 <= w_2) /\ (w_2 < n_pre)) -> (((Znth (w_2) (vis2_m_2) (0)) <> 0) -> ((Znth (w_2) (sid_m_2) (0)) = (Znth (w_2) (sid_l_) (0)))))) (PreH8 : ((Znth v vis2_m_2 0) = 0)) (PreH9 : (csr_wf2 g_low_level_spec fadj_col_l_low_level_spec fadj_row_l_low_level_spec vis2_m_2 sid_m_2 )) (PreH10 : (csr2_faithful g_low_level_spec fadj_col_l_low_level_spec fadj_row_l_low_level_spec )) (PreH11 : ((adj_verts (g_low_level_spec)) = n_pre)) (PreH12 : (lo = (csr_lo (u_pre) (fadj_row_l_low_level_spec)))) (PreH13 : (hi = (csr_hi (u_pre) (fadj_row_l_low_level_spec)))) (PreH14 : (0 <= lo)) (PreH15 : (lo <= i)) (PreH16 : (i < hi)) (PreH17 : (hi <= (m_of (fadj_row_l_low_level_spec)))) (PreH18 : (0 <= u_pre)) (PreH19 : (u_pre < n_pre)) (PreH20 : (0 <= root_pre)) (PreH21 : (root_pre < n_pre)) (PreH22 : (n_pre <= INT_MAX)) (PreH23 : ((Znth (u_pre) (vis2_m_2) (0)) <> 0)) (PreH24 : ((Znth (u_pre) (sid_m_2) (0)) = (Znth (root_pre) (sid_m_2) (0)))) (PreH25 : forall (j_2: Z) , (((lo <= j_2) /\ (j_2 < i)) -> ((Znth ((Znth (j_2) (fadj_col_l_low_level_spec) (0))) (vis2_m_2) (0)) <> 0))) (PreH26 : (0 <= v)) (PreH27 : (v < n_pre)) (PreH28 : (v = (Znth (i) (fadj_col_l_low_level_spec) (0)))) ,
  (IntArray.full fadj_col_pre (m_of (fadj_row_l_low_level_spec)) fadj_col_l_low_level_spec )
  **  (IntArray.full fadj_row_pre (n_pre + 1 ) fadj_row_l_low_level_spec )
  **  (IntArray.full vis2_pre n_pre vis2_l_ )
  **  (IntArray.full sid_pre n_pre sid_l_ )
...
(
forall (sid_pre: Z) (vis2_pre: Z) (fadj_row_pre: Z) (fadj_col_pre: Z) (n_pre: Z) (u_pre: Z) (root_pre: Z) (X_low_level_spec: (unit -> (KSt -> Prop))) (root_v_low_level_spec: Z) (fadj_row_l_low_level_spec: (@list Z)) (fadj_col_l_low_level_spec: (@list Z)) (g_low_level_spec: AdjGraph) (vis2_m_2: (@list Z)) (sid_m_2: (@list Z)) (i: Z) (lo: Z) (hi: Z) (v: Z) (PreH1 : ((Znth v vis2_m_2 0) <> 0)) (PreH2 : (csr_wf2 g_low_level_spec fadj_col_l_low_level_spec fadj_row_l_low_level_spec vis2_m_2 sid_m_2 )) (PreH3 : (csr2_faithful g_low_level_spec fadj_col_l_low_level_spec fadj_row_l_low_level_spec )) (PreH4 : ((adj_verts (g_low_level_spec)) = n_pre)) (PreH5 : (safeExec (pre_dfs2 (g_low_level_spec) (fadj_col_l_low_level_spec) (fadj_row_l_low_level_spec) (vis2_m_2) (sid_m_2) (root_v_low_level_spec)) (dfs_scc_from (g_low_level_spec) (fadj_col_l_low_level_spec) (fadj_row_l_low_level_spec) (root_pre) (u_pre) (i)) X_low_level_spec )) (PreH6 : (lo = (csr_lo (u_pre) (fadj_row_l_low_level_spec)))) (PreH7 : (hi = (csr_hi (u_pre) (fadj_row_l_low_level_spec)))) (PreH8 : (0 <= lo)) (PreH9 : (lo <= i)) (PreH10 : (i < hi)) (PreH11 : (hi <= (m_of (fadj_row_l_low_level_spec)))) (PreH12 : (0 <= u_pre)) (PreH13 : (u_pre < n_pre)) (PreH14 : (0 <= root_pre)) (PreH15 : (root_pre < n_pre)) (PreH16 : (n_pre <= INT_MAX)) (PreH17 : ((Znth (u_pre) (vis2_m_2) (0)) <> 0)) (PreH18 : ((Znth (u_pre) (sid_m_2) (0)) = (Znth (root_pre) (sid_m_2) (0)))) (PreH19 : forall (j_2: Z) , (((lo <= j_2) /\ (j_2 < i)) -> ((Znth ((Znth (j_2) (fadj_col_l_low_level_spec) (0))) (vis2_m_2) (0)) <> 0))) (PreH20 : (0 <= v)) (PreH21 : (v < n_pre)) (PreH22 : (v = (Znth (i) (fadj_col_l_low_level_spec) (0)))) ,
...
|--
  ...
  &&  “ ((((Znth (0) (vis2_l_low_level_spec) (0)) <> 0) -> ((Znth (0) (vis2_m) (0)) <> 0)) /\ (((Znth ((n_pre - 1 )) (vis2_l_low_level_spec) (0)) <> 0) -> ((Znth ((n_pre - 1 )) (vis2_m) (0)) <> 0))) ” 
...
forall (B: Type) ,
forall (sid_pre: Z) (vis2_pre: Z) (fadj_row_pre: Z) (fadj_col_pre: Z) (n_pre: Z) (u_pre: Z) (root_pre: Z) (f_bind_spec: (unit -> (@ StateRelMonad.M  KSt B))) (X_bind_spec: (B -> (KSt -> Prop))) (root_v_bind_spec: Z) (sid_l_bind_spec: (@list Z)) (vis2_l_bind_spec: (@list Z)) (fadj_row_l_bind_spec: (@list Z)) (fadj_col_l_bind_spec: (@list Z)) (g_bind_spec: AdjGraph) ,
...
forall (B: Type) ,
forall (timer_p_pre: Z) (fin_pre: Z) (vis1_pre: Z) (radj_row_pre: Z) (radj_col_pre: Z) (n_pre: Z) (u_pre: Z) (f_bind_spec: (unit -> (@ StateRelMonad.M  KSt B))) (X_bind_spec: (B -> (KSt -> Prop))) (timer_v_bind_spec: Z) (fin_l_bind_spec: (@list Z)) (vis1_l_bind_spec: (@list Z)) (radj_row_l_bind_spec: (@list Z)) (radj_col_l_bind_spec: (@list Z)) (g_bind_spec: AdjGraph) ,

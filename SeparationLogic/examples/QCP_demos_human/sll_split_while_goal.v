...
(
forall (p_pre_v: Z) (q_pre_v: Z) (x: Z) (l_2: (@list Z)) (l1_2: (@list Z)) (l2_2: (@list Z)) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (PreH1 : (x_next = 0)) (PreH2 : (l_2 = (cons (x_data) (l1_new)))) (PreH3 : (x <> 0)) (PreH4 : (q_pre_v = 0)) (PreH5 : (p_pre_v = 0)) ,
  (sll x_next l1_new )
|--
  “ (equiv (bind ((split_rec_rel (l1_new) (l2_2) ((cons (x_data) (l1_2))))) (reversepair)) (split_rec_rel ((@nil Z)) ((cons (x_data) (l1_2))) (l2_2)) ) ”
  &&  emp
).
...
(
forall (p_pre_v_2: Z) (q_pre_v_2: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (PreH1 : (x = 0)) (PreH2 : (q_pre_v_2 = 0)) (PreH3 : (p_pre_v_2 = 0)) ,
  (sll x l )
|--
  “ (equiv (split_rec_rel (l) (l1) (l2)) (return ((maketuple (l1) (l2)))) ) ”
  &&  emp
).
...
(
forall (q_pre: Z) (p_pre: Z) (p_pre_v: Z) (q_pre_v: Z) (q_v: Z) (p_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (PreH1 : (x_data <= INT_MAX)) (PreH2 : (x_data >= INT_MIN)) (PreH3 : (l = (cons (x_data) (l1_new)))) (PreH4 : (x <> 0)) (PreH5 : (q_pre_v = 0)) (PreH6 : (p_pre_v = 0)) ,
  ((( &( "x" ) )) # Ptr  |-> x_next)
  **  ((&((x)  # "list" ->ₛ "data")) # Int  |-> x_data)
  **  ((&((x)  # "list" ->ₛ "next")) # Ptr  |-> p_v)
  **  (sll x_next l1_new )
...
Definition split_while_partial_solve_wit_2_pure_split_goal_1 := 
forall (q_pre: Z) (p_pre: Z) (p_pre_v: Z) (q_pre_v: Z) (q_v: Z) (p_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (PreH1 : (x_data <= INT_MAX)) (PreH2 : (x_data >= INT_MIN)) (PreH3 : (l = (cons (x_data) (l1_new)))) (PreH4 : (x <> 0)) (PreH5 : (q_pre_v = 0)) (PreH6 : (p_pre_v = 0)) ,
  ((( &( "x" ) )) # Ptr  |-> x_next)
  **  ((&((x)  # "list" ->ₛ "data")) # Int  |-> x_data)
  **  ((&((x)  # "list" ->ₛ "next")) # Ptr  |-> p_v)
...
Definition split_while_partial_solve_wit_2_pure_split_goal_2 := 
forall (q_pre: Z) (p_pre: Z) (p_pre_v: Z) (q_pre_v: Z) (q_v: Z) (p_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (PreH1 : (x_data <= INT_MAX)) (PreH2 : (x_data >= INT_MIN)) (PreH3 : (l = (cons (x_data) (l1_new)))) (PreH4 : (x <> 0)) (PreH5 : (q_pre_v = 0)) (PreH6 : (p_pre_v = 0)) ,
  ((( &( "x" ) )) # Ptr  |-> x_next)
  **  ((&((x)  # "list" ->ₛ "data")) # Int  |-> x_data)
  **  ((&((x)  # "list" ->ₛ "next")) # Ptr  |-> p_v)
...
(
forall (q_pre: Z) (p_pre: Z) (X_low_level_spec: (((@list Z) * (@list Z)) -> (unit -> Prop))) (p_pre_v: Z) (q_pre_v: Z) (q_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (y: Z) (x_next_2: Z) (x_data_2: Z) (l1_new_2: (@list Z)) (PreH1 : (l1_new = (cons (x_data_2) (l1_new_2)))) (PreH2 : (x_next <> 0)) (PreH3 : (safeExec ATrue (bind ((split_rec_rel (l1_new) (l2) ((cons (x_data) (l1))))) (reversepair)) X_low_level_spec )) (PreH4 : (l = (cons (x_data) (l1_new)))) (PreH5 : (x <> 0)) (PreH6 : (q_pre_v = 0)) (PreH7 : (p_pre_v = 0)) ,
  ((( &( "x" ) )) # Ptr  |-> x_next_2)
...
(
forall (q_pre: Z) (p_pre: Z) (p_pre_v: Z) (q_pre_v: Z) (q_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (y: Z) (x_next_2: Z) (x_data_2: Z) (l1_new_2: (@list Z)) (PreH1 : (x_data <= INT_MAX)) (PreH2 : (x_data_2 <= INT_MAX)) (PreH3 : (x_data >= INT_MIN)) (PreH4 : (x_data_2 >= INT_MIN)) (PreH5 : (l1_new = (cons (x_data_2) (l1_new_2)))) (PreH6 : (x_next <> 0)) (PreH7 : (l = (cons (x_data) (l1_new)))) (PreH8 : (x <> 0)) (PreH9 : (q_pre_v = 0)) (PreH10 : (p_pre_v = 0)) ,
  ((( &( "x" ) )) # Ptr  |-> x_next_2)
  **  ((&((x_next)  # "list" ->ₛ "data")) # Int  |-> x_data_2)
  **  ((&((x_next)  # "list" ->ₛ "next")) # Ptr  |-> q_v)
  **  (sll x_next_2 l1_new_2 )
...
Definition split_while_partial_solve_wit_4_pure_split_goal_1 := 
forall (q_pre: Z) (p_pre: Z) (p_pre_v: Z) (q_pre_v: Z) (q_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (y: Z) (x_next_2: Z) (x_data_2: Z) (l1_new_2: (@list Z)) (PreH1 : (x_data <= INT_MAX)) (PreH2 : (x_data_2 <= INT_MAX)) (PreH3 : (x_data >= INT_MIN)) (PreH4 : (x_data_2 >= INT_MIN)) (PreH5 : (l1_new = (cons (x_data_2) (l1_new_2)))) (PreH6 : (x_next <> 0)) (PreH7 : (l = (cons (x_data) (l1_new)))) (PreH8 : (x <> 0)) (PreH9 : (q_pre_v = 0)) (PreH10 : (p_pre_v = 0)) ,
  ((( &( "x" ) )) # Ptr  |-> x_next_2)
  **  ((&((x_next)  # "list" ->ₛ "data")) # Int  |-> x_data_2)
  **  ((&((x_next)  # "list" ->ₛ "next")) # Ptr  |-> q_v)
...
Definition split_while_partial_solve_wit_4_pure_split_goal_2 := 
forall (q_pre: Z) (p_pre: Z) (p_pre_v: Z) (q_pre_v: Z) (q_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (y: Z) (x_next_2: Z) (x_data_2: Z) (l1_new_2: (@list Z)) (PreH1 : (x_data <= INT_MAX)) (PreH2 : (x_data_2 <= INT_MAX)) (PreH3 : (x_data >= INT_MIN)) (PreH4 : (x_data_2 >= INT_MIN)) (PreH5 : (l1_new = (cons (x_data_2) (l1_new_2)))) (PreH6 : (x_next <> 0)) (PreH7 : (l = (cons (x_data) (l1_new)))) (PreH8 : (x <> 0)) (PreH9 : (q_pre_v = 0)) (PreH10 : (p_pre_v = 0)) ,
  ((( &( "x" ) )) # Ptr  |-> x_next_2)
  **  ((&((x_next)  # "list" ->ₛ "data")) # Int  |-> x_data_2)
  **  ((&((x_next)  # "list" ->ₛ "next")) # Ptr  |-> q_v)
...
Definition split_while_partial_solve_wit_4_pure_split_goal_3 := 
forall (q_pre: Z) (p_pre: Z) (p_pre_v: Z) (q_pre_v: Z) (q_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (y: Z) (x_next_2: Z) (x_data_2: Z) (l1_new_2: (@list Z)) (PreH1 : (x_data <= INT_MAX)) (PreH2 : (x_data_2 <= INT_MAX)) (PreH3 : (x_data >= INT_MIN)) (PreH4 : (x_data_2 >= INT_MIN)) (PreH5 : (l1_new = (cons (x_data_2) (l1_new_2)))) (PreH6 : (x_next <> 0)) (PreH7 : (l = (cons (x_data) (l1_new)))) (PreH8 : (x <> 0)) (PreH9 : (q_pre_v = 0)) (PreH10 : (p_pre_v = 0)) ,
  ((( &( "x" ) )) # Ptr  |-> x_next_2)
  **  ((&((x_next)  # "list" ->ₛ "data")) # Int  |-> x_data_2)
  **  ((&((x_next)  # "list" ->ₛ "next")) # Ptr  |-> q_v)
...
Definition split_while_partial_solve_wit_4_pure_split_goal_4 := 
forall (q_pre: Z) (p_pre: Z) (p_pre_v: Z) (q_pre_v: Z) (q_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (y: Z) (x_next_2: Z) (x_data_2: Z) (l1_new_2: (@list Z)) (PreH1 : (x_data <= INT_MAX)) (PreH2 : (x_data_2 <= INT_MAX)) (PreH3 : (x_data >= INT_MIN)) (PreH4 : (x_data_2 >= INT_MIN)) (PreH5 : (l1_new = (cons (x_data_2) (l1_new_2)))) (PreH6 : (x_next <> 0)) (PreH7 : (l = (cons (x_data) (l1_new)))) (PreH8 : (x <> 0)) (PreH9 : (q_pre_v = 0)) (PreH10 : (p_pre_v = 0)) ,
  ((( &( "x" ) )) # Ptr  |-> x_next_2)
  **  ((&((x_next)  # "list" ->ₛ "data")) # Int  |-> x_data_2)
  **  ((&((x_next)  # "list" ->ₛ "next")) # Ptr  |-> q_v)
...
(
forall (x_data: Z) (l_new: (@list Z)) (l2: (@list Z)) (l1: (@list Z)) (l: (@list Z)) (p_v: Z) (PreH1 : (l = (cons (x_data) (l_new)))) (PreH2 : (p_v <> 0)) ,
  TT && emp 
|--
  “ (equiv (split_rec_rel (l) (l1) (l2)) (bind ((split_rec_rel (l_new) (l2) ((cons (x_data) (l1))))) (reversepair)) ) ”
  &&  emp
).
...
(
forall (x_data2: Z) (x_data: Z) (l_new: (@list Z)) (l2: (@list Z)) (l1: (@list Z)) (l: (@list Z)) (q_v: Z) (PreH1 : (l = (cons (x_data2) (l_new)))) (PreH2 : (q_v <> 0)) ,
  TT && emp 
|--
  “ (equiv (bind ((split_rec_rel (l) (l2) ((cons (x_data) (l1))))) (reversepair)) (split_rec_rel (l_new) ((cons (x_data) (l1))) ((cons (x_data2) (l2)))) ) ”
  &&  emp
).

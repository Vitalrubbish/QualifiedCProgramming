...
- 所有的文档开头的结构需要保持统一，以`20260610-scc-definition.md`为例
```markdown
# SCC-Definition
**Author**: <author-name>
**Date**: 2026-06-10
```
2. `docs/GraphLib` 包括了所有由 `agent` 生成的对 `SeperationLogic/GraphLib` 已有实现的解读，需要注意的是
...
在调用 `git checkout` 回滚之前必须向用户提出申请！！！
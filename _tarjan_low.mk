...
# put in _tarjan_low.mk.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in _tarjan_low.mk.local
#
###############################################################################
...
#
# There rules can be extended in _tarjan_low.mk.local
...
# extension points and _tarjan_low.mk.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in _tarjan_low.mk.local or include _tarjan_low.mk.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in _tarjan_low.mk.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create _tarjan_low.mk.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include _tarjan_low.mk.local-late
